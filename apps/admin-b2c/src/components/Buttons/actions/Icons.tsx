...
export const EditIcon: React.FC<IconProps> = ({ width = 16, height = 16, className }) => (
  <svg 
    ...
    className={className}
  >
    <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708L9.708 9.708a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168L12.146.146zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293L12.793 5.5z"/>
  </svg>
);
...
export const SpinnerIcon: React.FC<IconProps> = ({ width = 16, height = 16, className }) => (
  ...
  >
    <path d="M8 16a8 8 0 0 1-8-8 1 1 0 1 1 2 0 6 6 0 1 0 6-6 1 1 0 0 1 0-2 8 8 0 1 1 0 16z"/>
  </svg>
);
...
export const JSONIcon: React.FC<IconProps> = ({ width = 16, height = 16, className }) => (
  <svg 
    ...
    className={className}
  >
    <path d="M5 1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1z"/>
