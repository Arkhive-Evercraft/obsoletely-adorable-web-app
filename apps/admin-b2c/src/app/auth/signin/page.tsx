...
export default function SignIn() {
  ...
  return (
    ...
    <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ background: 'transparent' }}>
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              >
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <svg className="h-5 w-5 text-white opacity-80" fill="currentColor" viewBox="0 0 20 20">
